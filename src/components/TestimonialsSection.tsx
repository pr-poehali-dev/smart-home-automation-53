  ...
  const testimonials = [
    {
      ...
      quote: "Заказываю мясо уже полгода — всегда свежее, упаковано аккуратно. Доставляют быстро, как и обещают!",
      rating: 5,
    },
    {
      name: "Виктор С.",
      role: "Покупатель",
      quote: "Пельмени ручной лепки — просто восторг. Дети в восторге, беру каждую неделю.",
      rating: 5,
    },
    {
      name: "Ирина М.",
      role: "Постоянный покупатель",
      quote: "Очень удобно заказывать через приложение. Больше не трачу время на поездку в магазин.",
      rating: 5,
    },
    {
      name: "Андрей П.",
      role: "Покупатель",
      quote: "Говяжья вырезка — отличное качество. Делал шашлык, все гости были довольны. Буду брать снова!",
      rating: 5,
    },
    {
      name: "Светлана Т.",
      role: "Постоянный покупатель",
      quote: "Самовывоз очень удобен — можно забрать по дороге с работы. Мясо всегда свежее.",
      rating: 4,
    },
    {
      name: "Олег Р.",
      role: "Покупатель",
      quote: "Цены честные, мясо вкусное. Котлеты беру только здесь — жена одобрила!",
      rating: 5,
    },
    {
      name: "Екатерина В.",
      role: "Постоянный покупатель",
      quote: "Удобный каталог, легко найти нужное. Заказ собрали быстро и доставили вовремя.",
      rating: 5,
    },
    {
      name: "Дмитрий Н.",
      role: "Покупатель",
      quote: "Первый раз попробовал — очень понравилось. Свинина свежайшая, уже оформил второй заказ.",
      rating: 5,
    },
  ]
